#!/usr/bin/env python3
# QC interno (inspeções) → bi.db qc_designer — 1 linha por designer/dia.
# Fonte: warehouse gms_quality_inspection (db 13371339), veredito result_code
# YES/NO + total_score 0-100, designer via solution_code → gms_design.
# Uso: qc-feed.py            → D-1
